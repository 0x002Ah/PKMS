...
- The repo is at milestone **M1 — inbox capture contract** (see `docs/roadmap.md` and `docs/inbox-format.md`). The format is documented; there is no runtime code yet. Do not pre-build later milestones (e.g. the Telegram connector) without being asked.
